...
from stpredictions.OK3._classes import OK3Regressor, ExtraOK3Regressor
from stpredictions.OK3._forest import RandomOKForestRegressor, ExtraOKTreesRegressor
...
#%%
mse1 = np.mean(np.sum((y_test - y_pred1)**2, axis=1)) # gamma 0.01, maxleaf=50 ==> 70 ;  gamma 0.01, maxleaf=10 ==> 77
mse2 = np.mean(np.sum((y_test - y_pred2)**2, axis=1))
mse3 = np.mean(np.sum((y_test - y_pred3)**2, axis=1))
mse4 = np.mean(np.sum((y_test - y_pred4)**2, axis=1)) # gamma 0.01, maxleaf=50 ==> 55 ;  gamma 0.01, maxleaf=10 ==> 70
